    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if (not opt.nosave) or (final_epoch and not opt.evolve):  # if save
                ...
                # Save last, best and delete  保存训练的权重文件，根据自己的需求，可以不保存无关紧要的权重
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/car_data.yaml', help='data.yaml path')
